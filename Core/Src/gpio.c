...
void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB, LAMP_EN_Pin | LAMP_IND_LED0_Pin | LAMP_IND_LED1_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(MOTOR_nSLEEP_GPIO_Port, MOTOR_nSLEEP_Pin, GPIO_PIN_SET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOE, MOTOR_PH_Pin | MOTOR_EN_Pin, GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = LAMP_EN_Pin | LAMP_IND_LED0_Pin | LAMP_IND_LED1_Pin;
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_1 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12
                          ...
                          | GPIO_PIN_4 | GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
    ...
    GPIO_InitStruct.Pin = MOTOR_nSLEEP_Pin | MOTOR_PH_Pin | MOTOR_EN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
